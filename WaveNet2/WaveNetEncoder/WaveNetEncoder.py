...
class WaveNetEncoder(torch.nn.Module):
	def __init__(self, n_channels, n_layers, max_dilation, n_residual_channels, n_dilated_channels, encoding_factor, encoding_stride=1):
		...
		self.NCInput = Conv(self.n_channels, self.n_residual_channels)
